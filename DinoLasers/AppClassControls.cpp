...
#pragma region Other Actions
	ON_KEY_PRESS_RELEASE(Escape, NULL, PostMessage(m_pWindow->GetHandler(), WM_QUIT, NULL, NULL));// isPaused = !isPaused);//NULL, PostMessage(m_pWindow->GetHandler(), WM_QUIT, NULL, NULL)
